...
EVENT_FLOW_STAGE: dict[str, str] = {
    ...
    "diff_analysis_cli_started": "试飞优化 CLI 开始",
    "diff_analysis_cli_finished": "试飞优化 CLI 结束",
    "diff_analysis_develop_started": "试飞优化 · 问题修复",
    "diff_analysis_develop_finished": "试飞优化 · 修复轮结束",
    "diff_analysis_task_finished": "试飞优化 · 明细完成",
    "diff_analysis_flight_failed": "试飞优化 · 试飞未通过",
