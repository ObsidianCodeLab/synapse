...
from .version import MIN_SYNAPSE_VERSION, PLUGIN_API_VERSION, PLUGIN_UI_API_VERSION, SDK_VERSION
...
PLUGIN_TEMPLATES: dict[str, dict[str, Any]] = {
    ...
    "ui": {
        ...
        "code": textwrap.dedent('''\
            """Example full-stack UI plugin for Synapse (Plugin 2.0)."""
        ...
        "html": textwrap.dedent('''\
            ...
            <body>
              ...
              <script>
                ...
                window.Synapse.onReady(function () {
                  window.Synapse.api('GET', 'status').then(function (resp) {
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Scaffold an Synapse plugin")
