...
def _iter_app_venv_dirs() -> list[Path]:
    """Return candidate Synapse app-venv directories, nearest usable first."""
    ...
    add(Path.home() / ".synapse" / "runtime" / "app-venv")
    return dirs
...
def run_ytdlp_subprocess(
    ...
    *,
    ...
    """Run yt-dlp with Synapse-friendly env; use shell wrapper in frozen Windows."""
